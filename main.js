...
const handleFloatingLabels = () => {
    const inputs = getElements('.form-input, .form-textarea');
...
if (form) {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Remove has-content class from all form groups
            getElements('.form-group').forEach(group => {
            ...
            submitButton.innerHTML = '<i class="fa-solid fa-exclamation-triangle"></i> Error! Try Again';
            setTimeout(() => {
                submitButton.innerHTML = originalHTML;
                submitButton.disabled = false;
            }, 3000);
